  ...
  return (
    <Modal isOpen={true} onClose={close}>
      ...
      <ModalContent bg='gray.800'>
        ...
        <ModalBody>
          {!isLoading && <> <Text fontSize='sm' color='gray.500'>
          ...
          <InputGroup my='3'>
            ...
            <InputRightAddon
              ...
              children={<Icon _groupActive={{ transform: 'scale(0.9)' }} transition='transform 50ms linear' color={showUnlock ? 'white' : 'gray.500'} h='28px' w='28px' as={showUnlock ? AiFillUnlock : AiFillLock} />}
            />
          </InputGroup>
        </ModalBody>
        <ModalFooter>
